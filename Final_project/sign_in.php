...
//  exit;
//}
$link = mysqli_connect("localhost","root","", "loginpasswd");
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  // Validate credentials
      ...
      $sql = "SELECT email, username, password FROM info WHERE username = ?";
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        $param_password = hash("sha256", trim($_POST["password"]));
            ...
            if(mysqli_stmt_num_rows($stmt) == 1){                    
                ...
                if(mysqli_stmt_fetch($stmt)){
                    if($hashed_password == hash("sha256",$password)){
                        ...
                        $password_err = "The username/password you entered was not valid.";
                    }
                }
            } else{
