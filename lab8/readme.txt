...
can be used to both square a number and take its square root. We also had two abstract classes, so I changed one of them to an interface to show that we can use both
common interfaces.
